...
<section class="ab-hero">
    ...
    <div class="ab-container">
        <div class="ab-hero__grid">
            ...
            {{-- Направления: мозаика из четырёх плиток.
            ...
            <ul class="ab-hero__tiles ab-in" style="--d:.16s">
                @foreach ($h['directions'] as $i => $d)
                    <li class="ab-tile ab-tile--{{ ['a', 'b', 'c', 'd'][$i] ?? 'b' }}">
                        <a class="ab-tile__link" href="{{ $d['href'] }}">
                            ...
                            <span class="ab-tile__body">
                                ...
                                {{-- Раскрывается при наведении, на телефоне видно сразу:
                                     по одному названию не всегда понятно, о чём направление. --}}
                                <span class="ab-tile__note">{{ $d['text'] }}</span>
                            </span>
                        </a>
                    </li>
                @endforeach
