...
<li class="bread-crumbs__nav-item">
<a class="bread-crumbs__nav-link bread-crumbs__nav-link-is-active text-regular" href="/busines.html">Для бизнеса</a>
</li>
</ul>
</nav>
</div>
...
<h1 class="hero__title heading-title-general">Услуги для Бизнеса</h1>
...
<img src="/assets/busines.png" alt="кофейный бизнес с нуля - школа бариста">
</div>
</div>
</div>
</section>
...
<h2 class="courses__title heading-title-section">Программы и
                    курсы</h2>
<div class="courses__body">
<article class="courses__card">
<div class="courses__card-image">
<img loading="lazy" src="/assets/12.jpg" alt="Подбор поставщиков и оборудования для кофейни">
</div>
...
<path fill="currentColor" fill-rule="evenodd" d="M0 3.75A.75.75 0 0 1 .75 3h14.5a.75.75 0 0 1 0 1.5H.75A.75.75 0 0 1 0 3.75ZM0 8a.75.75 0 0 1 .75-.75h14.5a.75.75 0 0 1 0 1.5H.75A.75.75 0 0 1 0 8Zm.75 3.5a.75.75 0 0 0 0 1.5h9.5a.75.75 0 0 0 0-1.5H.75Z" clip-rule="evenodd">
</path>
</svg>
<span>Основное</span>
</button>
...
<h3 class="courses__card-name heading-title-name">
...
<span class="text-small">8 000 ₽</span>
</div>
<div class="courses__card-col">
...
<span class="text-small">1 день 4 часа</span>
</div>
</div>
<p class="courses__card-text text-small">Мы поможем подобрать всё необходимое
                                            ...
                                            кофе, молока, сиропов, посуды и инвентаря.</p>
</div>
</div>
<div class="courses__card-descr">
<div class="courses__card-information">
<h3 class="courses__card-label">Что входит в
                                        наши услуги:</h3>
...
<p class="courses__card-text text-small">Хотите быстро и безопасно собрать всё
                                            необходимое для кофейни? Оставьте заявку — начнём уже сегодня</p>
</div>
</div>
...
<article class="courses__card">
<div class="courses__card-image">
<img loading="lazy" src="/assets/22.jpg" alt="Разработка меню для кофейни">
</div>
<div class="courses__card-body">
<nav class="courses__card-nav">
<button class="courses__card-nav-button active">
...
<span class="text-small">от 15 000 ₽</span>
</div>
<div class="courses__card-col">
<svg class="courses__card-icon" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M22 12C22 17.52 17.52 22 12 22C6.48 22 2 17.52 2 12C2 6.48 6.48 2 12 2C17.52 2 22 6.48 22 12Z" stroke="#DFDFEC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
<span class="text-small">2 дня по 3 часа</span>
</div>
</div>
<p class="courses__card-text text-small">Меню — это сердце вашей кофейни. Оно
                                            ...
                                            привлечет гостей и увеличит прибыль.</p>
</div>
</div>
<div class="courses__card-descr">
<div class="courses__card-information">
...
<div>
<span class="courses__card-text-strong text-small">Формирование базового кофейного меню</span>
<p class="text-small">Мы создадим классическую карту напитков:
                                                        ...
                                                        вписалось в ваш бизнес.</p>
</div>
</div>
<div class="courses__card-item">
<div>
<span class="courses__card-text-strong text-small">Разработка сезонных и авторских напитков</span>
<p class="text-small">Хотите выделиться? Мы придумаем уникальные
                                                        ...
                                                        сохраняя их привлекательность и рентабельность.</p>
</div>
</div>
<div class="courses__card-item">
<div>
<span class="courses__card-text-strong text-small">Собираем сбалансированную карту напитков</span>
<p class="text-small">Мы соберем меню, где классика и креатив
                                                        дополняют друг друга. Каждый гость найдет свой любимый напиток,
                                                        что повысит лояльность и средний чек.</p>
</div>
</div>
</div>
...
<p class="courses__card-text text-small">Наша цель — сделать процесс работы
                                            ...
                                            кофейни с нами — это шаг к успеху вашего бизнеса.</p>
</div>
</div>
<a class="courses__card-button button button-brown" href="#give">Оставить заявку
                                    <svg class="button-icon" width="14" height="14" viewbox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<article class="courses__card">
<div class="courses__card-image">
<img loading="lazy" src="/assets/3.webp" alt="Проектирование барной зоны для кофейни">
</div>
<div class="courses__card-body">
<nav class="courses__card-nav">
<button class="courses__card-nav-button active">
...
<span class="text-small">От 3-х до 7-ми дней</span>
</div>
</div>
...
<div class="courses__card-item">
<div>
<span class="courses__card-text-strong text-small">Онлайн-консультация с разбором проекта</span>
<p class="text-small">Анализ помещения, оборудования, особенностей
                                                        локации и формата взаимодействия с гостями</p>
</div>
</div>
<div class="courses__card-item">
<div>
<span class="courses__card-text-strong text-small">Разработка дизайна барной зоны</span>
<p class="text-small">От пустого пространства до полной
                                                        визуализации, отражающей концепцию кофейни.</p>
</div>
</div>
<div class="courses__card-item">
<div>
<span class="courses__card-text-strong text-small">Проектирование бара под ключ</span>
<p class="text-small">Планировка, расстановка техники, схемы
                                                        коммуникаций, подбор отделки и оборудования — в связке с меню и
                                                        предполагаемой нагрузкой</p>
</div>
</div>
</div>
...
<article class="courses__card">
<div class="courses__card-image">
<img loading="lazy" src="/assets/4.jpg" alt="Индивидуальная программа обучения бариста">
</div>
<div class="courses__card-body">
<nav class="courses__card-nav">
<button class="courses__card-nav-button active">
...
<span class="text-small">от 2 500 ₽</span>
</div>
<div class="courses__card-col">
<svg class="courses__card-icon" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M22 12C22 17.52 17.52 22 12 22C6.48 22 2 17.52 2 12C2 6.48 6.48 2 12 2C17.52 2 22 6.48 22 12Z" stroke="#DFDFEC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
<span class="text-small">Индивидуально</span>
</div>
</div>
...
<div class="courses__card-item">
<div>
<p class="text-small">Техники продаж и презентация напитков, чтобы
                                                    бариста мог не только готовить, но и продавать</p>
</div>
</div>
<div class="courses__card-item">
<div>
<p class="text-small">Оптимизация работы за барной стойкой и
                                                    увеличение скорости отдачи напитков</p>
</div>
</div>
<div class="courses__card-item">
<div>
<p class="text-small">Настройка помола кофе, взбивание молока и
                                                    базовый латте-арт</p>
</div>
</div>
<div class="courses__card-item">
<div>
<p class="text-small">Альтернативные способы заваривания кофе для
                                                    расширения ассортимента</p>
</div>
</div>
<div class="courses__card-item">
<div>
<p class="text-small">Практические рекомендации с учётом формата
                                                    вашей кофейни и целевой аудитории</p>
</div>
</div>
</div>
...
<p class="courses__card-text courses__card-text-strong text-small">Хотите
                                            ...
                                            составим программу обучения под ваши задачи!</p>
</div>
</div>
<a class="courses__card-button button button-brown" href="#give">Оставить заявку
                                    <svg class="button-icon" width="14" height="14" viewbox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<article class="courses__card">
<div class="courses__card-image">
<img loading="lazy" src="/assets/52.jpg" alt="Кофейня с нуля - пошаговый запуск кофейни">
</div>
<div class="courses__card-body">
<nav class="courses__card-nav">
<button class="courses__card-nav-button active">
...
<span class="text-small">от 50 000 ₽</span>
</div>
<div class="courses__card-col">
<svg class="courses__card-icon" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M22 12C22 17.52 17.52 22 12 22C6.48 22 2 17.52 2 12C2 6.48 6.48 2 12 2C17.52 2 22 6.48 22 12Z" stroke="#DFDFEC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
<span class="text-small">от 3-х недель</span>
</div>
</div>
...
<div class="courses__card-descr">
<div class="courses__card-information">
<h3 class="courses__card-label">Что включает
...
<p class="courses__card-text courses__card-text-strong text-small">Хотите
                                            ...
                                            строить ваш успешный кофейный бизнес!</p>
</div>
</div>
<a class="courses__card-button button button-brown" href="#give">Оставить заявку
                                    <svg class="button-icon" width="14" height="14" viewbox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<article class="courses__card">
<div class="courses__card-image">
<img loading="lazy" src="/assets/62.jpg" alt="Курс «Менеджмент кофейни»">
</div>
<div class="courses__card-body">
<nav class="courses__card-nav">
<button class="courses__card-nav-button active">
...
<span class="text-small">25 000 ₽</span>
</div>
<div class="courses__card-col">
<svg class="courses__card-icon" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M22 12C22 17.52 17.52 22 12 22C6.48 22 2 17.52 2 12C2 6.48 6.48 2 12 2C17.52 2 22 6.48 22 12Z" stroke="#DFDFEC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
<div class="courses__card-descr">
<div class="courses__card-information">
<h3 class="courses__card-label">На курсе вы
                                        узнаете:</h3>
<ul class="courses__card-list">
...
<p class="courses__card-text courses__card-text-strong text-small">Хотите
                                            ...
                                            начните строить успешный кофейный бизнес уже сегодня!</p>
</div>
</div>
<a class="courses__card-button button button-brown" href="#give">Оставить заявку
                                    <svg class="button-icon" width="14" height="14" viewbox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<article class="courses__card">
<div class="courses__card-image">
<img loading="lazy" src="/assets/72.jpg" alt="Консалтинг «Кофейня под ключ»">
</div>
<div class="courses__card-body">
<nav class="courses__card-nav">
<button class="courses__card-nav-button active">
...
<span class="text-small">от 100 000 ₽</span>
</div>
<div class="courses__card-col">
<svg class="courses__card-icon" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M22 12C22 17.52 17.52 22 12 22C6.48 22 2 17.52 2 12C2 6.48 6.48 2 12 2C17.52 2 22 6.48 22 12Z" stroke="#DFDFEC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
<p class="courses__card-text text-small">Открытие кофейни — это большой и
                                            ...
                                            идеи до привлечения первых клиентов.</p>
</div>
</div>
<div class="courses__card-descr">
<div class="courses__card-information">
<h3 class="courses__card-label">Программа
                                        включает:</h3>
<ul class="courses__card-list">
...
<article class="courses__card">
<div class="courses__card-image">
<img loading="lazy" src="/assets/82.jpg" alt="Онлайн / Оффлайн «Как открыть кофейню»">
</div>
<div class="courses__card-body">
<nav class="courses__card-nav">
<button class="courses__card-nav-button active">
...
<span class="text-small">7 000 ₽</span>
</div>
<div class="courses__card-col">
<svg class="courses__card-icon" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M22 12C22 17.52 17.52 22 12 22C6.48 22 2 17.52 2 12C2 6.48 6.48 2 12 2C17.52 2 22 6.48 22 12Z" stroke="#DFDFEC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
<p class="courses__card-text text-small">Мечтаете о собственной кофейне, но не
                                            ...
                                            помогает открывать кофейни с 2019 года.</p>
</div>
</div>
<div class="courses__card-descr">
<div class="courses__card-information">
<h3 class="courses__card-label">Для кого этот
                                        семинар:</h3>
<ul class="courses__card-list">
...
<p class="courses__card-text text-small">За один день вы получите полное
                                            ...
                                            первый шаг к успешному кофейному бизнесу!</p>
</div>
</div>
<a class="courses__card-button button button-brown" href="#give">Оставить заявку
                                    <svg class="button-icon" width="14" height="14" viewbox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<h2 class="give__title heading-title-section">Оставьте заявку</h2>
...
<input type="hidden" class="form-purpose" value="Тип заявки: Консультация по бизнесу">
</form>
</div>
</div>
</section>
...
<input type="hidden" class="form-purpose" value="Тип заявки: Для бизнеса">
</form>
</div>
</div>
</div>
