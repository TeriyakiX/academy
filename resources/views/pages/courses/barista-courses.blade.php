...
<span class="bread-crumbs__nav-arrow text-regular">&gt;</span>
<li class="bread-crumbs__nav-item">
<a class="bread-crumbs__nav-link bread-crumbs__nav-link-is-active text-regular" href="/courses/barista-courses.html">Курсы Бариста</a>
</li>
</ul>
</nav>
</div>
...
<h1 class="courses__title heading-title-general">курсы бариста</h1>
<div class="courses__body">
<article class="courses__card">
<div class="courses__card-image">
<img src="/assets/1.jpeg" alt="Бариста Базовый - Школа бариста в Москве">
</div>
<div class="courses__card-wrap">
<div class="courses__card-info">
<h3 class="courses__card-name heading-medium">Бариста базовый</h3>
...
<span class="courses__card-information-text text-small">В удобное время</span>
</li>
<li class="courses__card-item">
...
<span class="courses__card-information-text text-small">Очный формат</span>
</li>
<li class="courses__card-item">
<svg class="courses__card-icon" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<img src="/assets/2.jpg" alt="Бариста Продвинутый - Школа бариста в Москве">
</div>
<div class="courses__card-wrap">
<div class="courses__card-info">
<h3 class="courses__card-name heading-medium">Бариста Продвинутый</h3>
...
<article class="courses__card">
<div class="courses__card-image">
<img src="/assets/15.jpg" alt="Бариста Техник - Школа бариста в Москве">
</div>
<div class="courses__card-wrap">
<div class="courses__card-info">
<h3 class="courses__card-name heading-medium">Бариста Техник</h3>
<ul class="courses__card-list">
<li class="courses__card-item">
<svg class="courses__card-icon" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M22 12C22 17.52 17.52 22 12 22C6.48 22 2 17.52 2 12C2 6.48 6.48 2 12 2C17.52 2 22 6.48 22 12Z" stroke="#DFDFEC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
<article class="courses__card">
<div class="courses__card-image">
<img src="/assets/3.png" alt="Бариста Professional - Школа бариста в Москве">
</div>
<div class="courses__card-wrap">
<div class="courses__card-info">
<h3 class="courses__card-name heading-medium">Бариста Professional</h3>
<ul class="courses__card-list">
<li class="courses__card-item">
<svg class="courses__card-icon" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M22 12C22 17.52 17.52 22 12 22C6.48 22 2 17.52 2 12C2 6.48 6.48 2 12 2C17.52 2 22 6.48 22 12Z" stroke="#DFDFEC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
<article class="courses__card">
<div class="courses__card-image">
<img src="/assets/14.png" alt="Управляющий кофейни - Школа бариста в Москве">
</div>
<div class="courses__card-wrap">
<div class="courses__card-info">
<h3 class="courses__card-name heading-medium">Управляющий кофейни</h3>
<ul class="courses__card-list">
<li class="courses__card-item">
<svg class="courses__card-icon" width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M22 12C22 17.52 17.52 22 12 22C6.48 22 2 17.52 2 12C2 6.48 6.48 2 12 2C17.52 2 22 6.48 22 12Z" stroke="#DFDFEC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
<input type="hidden" class="form-purpose" value="Тип заявки: Страница 'Курсы Бариста'">
</form>
</div>
</div>
</div>
