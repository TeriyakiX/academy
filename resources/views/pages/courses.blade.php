...
<li class="bread-crumbs__nav-item">
<a class="bread-crumbs__nav-link bread-crumbs__nav-link-is-active text-regular" href="/courses.html">Курсы</a>
</li>
</ul>
</nav>
</div>
...
<h1 class="courses__title heading-title-general">курсы и
                    программы</h1>
...
<div class="courses__body-wrapper" data-course="barista">
<h2 class="courses__body-title heading-title-section">Курсы Бариста</h2>
...
<article class="courses__card splide__slide">
<div class="courses__card-info">
<h3 class="courses__card-name heading-title-name">Бариста
                                                продвинутый</h3>
...
<article class="courses__card splide__slide">
<div class="courses__card-info">
<h3 class="courses__card-name heading-title-name">Управляющий
                                                кофейни</h3>
...
<div class="courses__body-wrapper" data-course="master-class">
<h2 class="courses__body-title heading-title-section">Мастер классы</h2>
<div class="courses__body-content courses__body-content-is-active master-class-slider splide">
<div class="courses__body-track splide__track">
<div class="courses__body-list splide__list">
<article class="courses__card splide__slide">
<div class="courses__card-info">
<h3 class="courses__card-name heading-title-name">Бариста в Take
                                                away</h3>
...
<div class="courses__body-wrapper" data-course="barnoe-delo">
<h2 class="courses__body-title heading-title-section">Барное дело</h2>
<div class="courses__body-content courses__body-content-is-active barnoe-delo-slider splide">
<div class="courses__body-track splide__track">
<div class="courses__body-list splide__list">
<article class="courses__card splide__slide">
<div class="courses__card-info">
<h3 class="courses__card-name heading-title-name">Магия коктейлей:
                                                Встряхни и подай</h3>
...
<article class="courses__card splide__slide">
<div class="courses__card-info">
<h3 class="courses__card-name heading-title-name">Вкус и стиль:<br>метод
                                                Стир</h3>
...
<article class="courses__card splide__slide">
<div class="courses__card-info">
<h3 class="courses__card-name heading-title-name">Изысканный Коктейль
                                                методом “Билд”</h3>
...
<h4 class="blog__vertical-text heading-title-vertical">Блог</h4>
<div class="blog__container container">
<h2 class="blog__title heading-title-section">Новости и
                    статьи</h2>
