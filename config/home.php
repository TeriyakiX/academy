...
return [
    ...
    /* ---------- Чем занимается школа ----------
       Человек с рекламы часто не знает, что кроме курсов здесь есть
       оборудование, сертификаты и помощь с запуском кофейни.
       Карточки короткие: это указатели, а не рассказ. */
    'lines' => [
        'title' => 'Чем занимается Академия Бариста',
        'lead'  => 'Четыре направления одного дела — от первого курса до открытой кофейни.',
        'items' => [
            [
                'tag'   => 'Школа',
                'title' => 'Обучение бариста',
                'text'  => 'Курсы и мастер-классы с практикой на профессиональном оборудовании.',
                'href'  => '/courses.html',
                'note'  => '13 программ',
            ],
            [
                'tag'   => 'Маркет',
                'title' => 'Оборудование для кофеен',
                'text'  => 'Кофемашины, кофемолки и аксессуары. Подбираем под формат заведения.',
                'href'  => '/shop.html',
                'note'  => '89 позиций',
            ],
            [
                'tag'   => 'Для бизнеса',
                'title' => 'Кофейня под ключ',
                'text'  => 'Барная зона, оборудование, меню и обученная команда.',
                'href'  => '/busines.html',
                'note'  => 'от идеи до запуска',
            ],
            [
                'tag'   => 'Сертификаты',
                'title' => 'Обучение в подарок',
                'text'  => 'Сертификат на любые программы школы, собирается за два шага.',
    ...
    /* ---------- Всплывающее предложение ----------
       Небольшая карточка в углу: показывается один раз за неделю,
       закрывается и больше не мешает. Содержимое здесь, чтобы менять
       предложение без правки вёрстки. */
    'promo' => [
        'enabled' => true,
        'tag'     => 'Подарочный сертификат',
        'title'   => 'Подарите обучение',
        'text'    => 'Сертификат на любые программы школы. Собирается за два шага, скидка растёт от количества программ.',
        'action'  => 'Собрать сертификат',
        'href'    => '/sertifikat.html#oformit',
        /* через сколько секунд появиться и после какой доли прокрутки */
        'delay'   => 14,
        'scroll'  => 0.3,
    ],
    ...
    /* ---------- График занятий ---------- */
    'schedule' => [
        'title' => 'Когда идут занятия',
        'lead'  => 'Выберите формат: будни, выходные или занятие один на один.',
        'note'  => 'Пропустили занятие — отработаете его с другой группой бесплатно.',
        'items' => [
            [
                'title'    => 'По будням',
                'times'    => ['утро', 'день', 'вечер'],
                'length'   => '2 дня по 4 часа',
                'audience' => 'Базовые курсы бариста',
            ],
            [
                'title'    => 'По выходным',
                'times'    => ['утро', 'вечер'],
                'length'   => '1 день 8 часов',
                'audience' => 'Тем, кто работает в будни',
            ],
            [
                'title'    => 'Индивидуально',
                'times'    => [],
                'length'   => 'по договорённости',
                'audience' => 'Занятие один на один с тренером',
            ],
        ],
    ],
    'steps' => [
