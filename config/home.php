...
return [
    ...
    'about' => [
        ...
        // ВНИМАНИЕ: год основания требует подтверждения. В правках указан «2020 (?)»,
        // при этом бейдж и блок «в цифрах» говорят о 4 годах работы, то есть о 2022-м.
        'demo'  => true,
        'text'  => 'Работаем в Москве с 2022 года. Учим и тех, кто только начинает карьеру '
                 . 'в кофейной индустрии, и опытных специалистов.',
        'badge' => ['value' => '4 года', 'label' => 'в кофейном бизнесе'],
        'facts' => [
            'Обучение по образовательной лицензии',
            'Практика на профессиональном оборудовании',
            'Свидетельство о присвоении квалификации',
    ...
    /* ---------- Расписание мероприятий ----------
     ...
     | где они уже были условными. Требуют актуальных данных от заказчика.
     */
    'events' => [
        'demo'   => true,
        'months' => [
    ...
    'teachers' => [
        ...
        'items' => [
            [
                ...
                'experience' => null, // сколько лет в профессии — уточнить у заказчика
