...
return [
    ...
    /* ---------- Чем занимается школа ----------
       ...
       оборудование и помощь с запуском кофейни. Три направления одним
       блоком: видно сразу, дальше он выбирает своё. */
    'lines' => [
        'title' => 'Академия Бариста — это школа, оборудование и запуск кофеен',
        'lead'  => 'Три направления одного дела: учим бариста, поставляем технику и помогаем открыть кофейню.',
        'items' => [
            [
                'tag'   => 'Школа',
                'title' => 'Обучение бариста',
                'text'  => 'Курсы и мастер-классы с практикой на профессиональном оборудовании — от первой чашки эспрессо до управления кофейней.',
                'href'  => '/courses.html',
                'note'  => '13 программ',
            ],
            [
                ...
                'text'  => 'Кофемашины, кофемолки и аксессуары ведущих марок. Подбираем под формат заведения и поток гостей.',
                'href'  => '/shop.html',
                'note'  => '89 позиций',
            ],
            [
                ...
                'text'  => 'От подбора оборудования и проектирования барной зоны до меню и обученной команды.',
                'href'  => '/busines.html',
                'note'  => 'от консультации до запуска',
            ],
        ],
    ],
