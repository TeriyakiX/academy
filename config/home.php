...
return [
    ...
    'hero' => [
        ...
        'directions' => [
            ['title' => 'Бариста',       'href' => '/courses.html'],
            ['title' => 'Мастер-классы', 'href' => '/courses/master-class.html'],
            ['title' => 'Барменам',      'href' => '/courses/barnoe-delo.html'],
            ['title' => 'Для бизнеса',   'href' => '/busines.html'],
            ['title' => 'Свой курс',     'href' => '/constructor.html'],
        ],

        'facts' => [
            'Преподаём с образовательной лицензией',
            '+4 года опыта в кофейной индустрии',
            '+1000 учеников выпустились из школы',
            '90% курса — чистая практика',
        ],
